...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'if it's worth writing, it's worth keeping.',   
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xiaokai.world', // 网站地址          
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'xiaokai BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '欢迎关注', // 站点描述，被notion中的页面描述覆盖
